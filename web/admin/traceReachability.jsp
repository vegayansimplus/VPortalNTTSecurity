<%-- 
    Document   : traceReachability
    Created on : 11 Apr, 2025, 3:43:48 PM
    Author     : lapto
--%>
...
<!--                            <div id="nodeNameDiv" class=" form-group col-md-3">
                            ...
                            <div id="TimeViewReport" class="col-md-2" style="width: 250px;">
                                <div class="col-md-3">
                                    <button id="getReport" class="btn vega-btn" onclick="getTraceStatus();">Trace</button>
                                </div>
                            </div>
                        </div>
                    </div>
