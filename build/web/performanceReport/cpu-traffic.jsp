            ...
            function viewReport() {
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        $("#reportTitle").html("<b>CPU Report</b>");
                        ...
                        $('#reportTable tbody').on('click', 'tr', function () {
                            ...
                            $(".chartModelTitle").html("<b>CPU Util Connection for</b>  " + $('#reportTable').DataTable().row(this).data()[2] + " : " + $('#reportTable').DataTable().row(this).data()[3]);
                            ...
                            $.ajax({
                                type: "POST",
                                url: "../ReportPlots",
                                data: {requestType: "3", nodeName: $('#reportTable').DataTable().row(this).data()[2], kpiName: $('#reportTable').DataTable().row(this).data()[3], fromTime: fromTime, toTime: toTime, dbType: dbType, kpiflag: "CPU"},
                                dataType: "json",
                                success: function (data) {
                                    $(".loadingLabel").hide();
                                    ...
                                    console.log(data);
                                    var jsonData = data;
                                    var temp = "<table id='example2' class='display compact cell-border' cellspacing='0'  width='100%'><thead><tr><th>CPU Util</th><th>Time</th></tr></thead><tbody>";
